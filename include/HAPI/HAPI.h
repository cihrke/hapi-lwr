...
/* #undef HAVE_OPENHAPTICS */

/// Undef if you do not have Chai3d installed
/* #undef HAVE_CHAI3D */
/* #undef CHAI3D_VERSION_2_0 */
...
/* #undef HAVE_VIRTUOSEAPI */

/// Undef if you do not have FALCON API(www.novint.com) installed.
/* #undef HAVE_FALCONAPI */
/* #undef HAVE_NIFALCONAPI */

// Select which communication library libnifalcon should use
/* #undef NIFALCONAPI_LIBUSB */
/* #undef NIFALCONAPI_LIBFTD2XX */
/* #undef NIFALCONAPI_LIBFTDI */
...
#define HAPI_MINOR_VERSION 3
#define HAPI_BUILD_VERSION 1
